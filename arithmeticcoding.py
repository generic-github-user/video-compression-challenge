...
# 
# **This code has been modified (namely, pure-Python operations have been converted to NumPy operations where possible, and some safety checks have been omitted); original source is https://github.com/nayuki/Reference-arithmetic-coding/blob/fde1357935494f395b4d17ca7e9e897c226ad208/python/arithmeticcoding.py**
...
class SimpleFrequencyTable(FrequencyTable):
    ...
    def __init__(self, freqs):
        self.frequencies = np.pad(freqs, (1, 0))
        self.total = np.sum(self.frequencies)
        self.cumulative = np.cumsum(self.frequencies)
